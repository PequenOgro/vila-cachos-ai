      ...
      <header className="border-b border-stone-200/80 bg-white/70 backdrop-blur-md px-6 py-4 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          {screen !== 'welcome' && (
            <button
              onClick={handleReset}
              className="flex items-center space-x-1.5 text-xs font-semibold text-stone-500 hover:text-stone-800 bg-stone-100 hover:bg-stone-200/80 px-4 py-2 rounded-full transition min-h-[44px]"
            >
        ...
        {screen === 'welcome' && (
          <div className="text-center py-12 px-4 max-w-2xl mx-auto">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 bg-stone-900 hover:bg-stone-800 text-white font-medium text-lg px-8 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition transform hover:-translate-y-0.5 active:translate-y-0 min-h-[44px]"
            >
            ...
            <div className="mt-8 pt-6 border-t border-stone-200 flex items-center justify-between">
              {step > 1 ? (
                <button
                  ...
                  className="inline-flex items-center justify-center space-x-2 text-stone-600 hover:text-stone-900 font-semibold text-sm px-4 py-3 rounded-xl transition min-h-[44px]"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center text-stone-400 hover:text-stone-700 font-semibold text-sm px-4 py-3 rounded-xl transition min-h-[44px]"
                >
                  Cancelar
                </button>
              )}
              ...
              {step < 4 ? (
                <button
                  type="button"
                  onClick={() => setStep(prev => prev + 1)}
                  className="inline-flex items-center justify-center space-x-2 bg-stone-900 hover:bg-stone-800 text-white font-semibold text-sm px-6 py-3 rounded-xl transition shadow-md hover:shadow-lg min-h-[44px]"
                >
                  <span>Próximo</span>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center space-x-2 bg-stone-900 hover:bg-stone-800 text-amber-300 font-bold text-sm px-6 md:px-8 py-3.5 rounded-xl transition shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5 min-h-[44px]"
                >
        ...
        {screen === 'results' && recommendationResult && (
          <div className="space-y-6">
                          ...
                          <div className="flex justify-center items-center space-x-1.5">
                            {[1, 2, 3, 4, 5].map((nota) => (
                                <button
                                  ...
                                  className="w-11 h-11 min-h-[44px] min-w-[44px] rounded-full bg-white hover:bg-amber-100 border border-stone-200 flex items-center justify-center text-sm font-bold text-stone-700 hover:text-amber-900 transition active:scale-95 shadow-sm"
                                  title={`Dar nota ${nota}`}
                                >
                                {nota}★
                              </button>
            ...
            <div className="text-center pt-4">
              <button
                onClick={handleReset}
                className="inline-flex items-center justify-center w-full md:w-auto space-x-2 bg-stone-900 hover:bg-stone-800 text-white font-semibold text-sm px-6 py-3.5 rounded-xl transition shadow-md min-h-[44px]"
              >
